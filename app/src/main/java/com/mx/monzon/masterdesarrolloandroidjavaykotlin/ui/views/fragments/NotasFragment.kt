...
class NotasFragment : Fragment() {
    ...
    fun fillList(){
        ...
        listaNotas.add(Notas("Mensaje de MensClub", "Promoción de mes, invita a un amigo una semana y el tendrá la semana gratis y tu tendrás un fabuloso 20% de descuento en ese mes. valido solo por uma amistad",false,R.color.purpura_uva))
